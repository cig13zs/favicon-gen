...
[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/favicon-gen/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/favicon-gen/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/favicon-gen/](https://cig13zs.github.io/favicon-gen/) or install the offline Chrome Extension package.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/favicon-gen.git
   ```
